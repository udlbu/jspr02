...
class BeforeAspectTest {
    ...
    @Test
    @DisplayName("@Before AppPointcuts.methodsInServicePackageAndSubpackages() - Successful request")
    void before_methodsInServicePackageAndSubpackages_OK() throws Exception {
        String expectedOutput = String.join(System.lineSeparator(), BEFORE, BEFORE, "");
    ...
    @Test
    @DisplayName("@Before AppPointcuts.methodsInServicePackageAndSubpackages() - Exception thrown")
